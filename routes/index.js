    ...
    try {
        if(req.query.user) {
            ...
            var mailOptions = {
                ...
                html:  `<div style='font-family: Helvetica; position: absolute; left: 0; top: 0; width: 100%; display: flex; padding: 5px 0;'><div style='background: white; border: 1px solid #e5e5e5; width: 600px; margin: 0 auto; padding: 20px;'><div style='position: relative; left: 0; width: 100%; color: blue; font-size: 30px;'>Welcome to the Recipes App!</div><p style="color: black">Hello ${user.firstName},</p><p style="color: black">Please click the link below to confirm your email address</p><a href='<%=process.env.ROOT_URL%>confirmation-code?user=${user._id}&code=${confCode}'><%=process.env.ROOT_URL%>confirmation-code?user=${user._id}&code=${confCode}</a><p style="color: black">If you didn't create a Recipes account, please ignore this message.</p></div></div>`
            };
    ...
    try {
        ...
        if(user) {
            ...
            var mailOptions = {
                ...
                to: email,
                subject: 'Confirm your email address',
                html:  `<div style='font-family: Helvetica; position: absolute; left: 0; top: 0; width: 100%; display: flex; padding: 5px 0;'><div style='background: white; border: 1px solid #e5e5e5; width: 600px; margin: 0 auto; padding: 20px;'><div style='position: relative; left: 0; width: 100%; blue; font-size: 30px;'>Welcome to the Recipes App!</div><p style="color: black">Hello ${user.firstName},</p><p style="color: black">Please click the link below to confirm your email address</p><a href='<%=process.env.ROOT_URL%>confirmation-code?user=${user._id}&code=${confCode}'><%=process.env.ROOT_URL%>confirmation-code?user=${user._id}&code=${confCode}</a><p style="color: black">If you didn't create a Recipes account, please ignore this message.</p></div></div>`
            };
            transporter.sendMail(mailOptions, function(error, info){
                if (error) {
                    console.log(error);
    ...
    try {
        ...
        if(user) {
            ...
            var mailOptions = {
                ...
                html:  `<div style='font-family: Helvetica; position: absolute; left: 0; top: 0; width: 100%; display: flex; padding: 5px 0;'><div style='background: white; border: 1px solid #e5e5e5; width: 600px; margin: 0 auto; padding: 20px;'><div style='position: relative; left: 0; width: 100%; blue; font-size: 30px;'>Welcome to the Recipes App!</div><p style="color: black">Hello ${user.firstName},</p><p style="color: black">Please click the link below to confirm your email address</p><a href='<%=process.env.ROOT_URL%>change-password?user=${user._id}&code=${confCode}'><%=process.env.ROOT_URL%>change-password?user=${user._id}&code=${confCode}</a><p style="color: black">If you didn't intend to send this email, please ignore this message.</p></div></div>`
            };
            transporter.sendMail(mailOptions, function(error, info){
                if (error) {
                    console.log(error);
